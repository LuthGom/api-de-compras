...
module.exports = class ProdutosDao {
    static cadastrarProduto(novoProduto) {
        const INSERT_INTO_Produtos = `INSERT INTO Produtos_Masculinos (titulo, descricao,preco,  url_imagem) VALUES (?,?,?,?);`
    ...
    static listarTodosOsProdutos() {
        const SELECT_ALL = 'SELECT * FROM Produtos_Masculinos;';
        return new Promise((resolve, reject) => {
        ...
        const SELECT_BY_ID = `SELECT * FROM Produtos_Masculinos WHERE id = ?`
        return new Promise((resolve, reject) => {
    ...
    static deletarProduto(id) {
        return new Promise((resolve, reject) => {
            const deletar = `DELETE FROM Produtos_Masculinos WHERE id = ?`
    ...
    static buscaProdutoPorTitulo(titulo) {
        const SELECT_BY_TITULO = `SELECT * FROM Produtos_Masculinos WHERE titulo = ?`
        return new Promise((resolve, reject) => {
